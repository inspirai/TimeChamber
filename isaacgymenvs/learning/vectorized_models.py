    ...
    class Network(ModelA2CContinuousLogStd.Network):
        ...
        def update(self, population_idx, network):
            for key in self.state_dict():
                ...
                # print(key, param1.shape, param2.shape)
                ...
                # print(key, param1.shape, param2.shape)
            # if hasattr(network, 'running_mean_std') and hasattr(self, 'running_mean_std'):
            #     self.running_mean_std.running_mean[population_idx] = network.running_mean_std.running_mean
            #     self.running_mean_std.running_var[population_idx] = network.running_mean_std.running_var
